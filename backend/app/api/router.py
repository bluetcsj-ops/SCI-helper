...
from app.api.routes import agents, chat, dashboard, data, health, journal, mentor, projects, reminders, users
...
api_router.include_router(journal.router, prefix="/api/journal", tags=["journal"])
